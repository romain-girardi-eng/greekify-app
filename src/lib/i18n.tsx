...
const fr = {
  ...
  streak: 'Série',
  days: 'jours',
  cards_learned: 'Mots appris',
  of: 'sur',
  retention: 'Réussite',
  accuracy: 'de bonnes réponses',
  total_reviews: 'Révisions',
  all_time: 'au total',
  activity: 'Activité',

  // Card breakdown
  card_breakdown: 'Répartition',
  ...
  complete_first_review: 'Révisez votre première carte pour débloquer des succès !',

  // Achievement names
  'achievement.first-card': 'Premiers pas',
  'achievement.first-card.desc': 'Révisez votre première carte',
  'achievement.vocab-10': 'Collectionneur',
  'achievement.vocab-10.desc': 'Apprenez 10 mots',
  'achievement.vocab-50': 'Apprenti',
  'achievement.vocab-50.desc': 'Apprenez 50 mots',
  'achievement.vocab-100': 'Érudit',
  'achievement.vocab-100.desc': 'Apprenez 100 mots',
  'achievement.vocab-500': 'Expert',
  'achievement.vocab-500.desc': 'Apprenez 500 mots',
  'achievement.streak-3': 'Régularité',
  'achievement.streak-3.desc': '3 jours consécutifs',
  'achievement.streak-7': 'Persévérance',
  'achievement.streak-7.desc': '7 jours consécutifs',
  'achievement.streak-30': 'Dévotion',
  'achievement.streak-30.desc': '30 jours consécutifs',
  'achievement.streak-100': 'Centurion',
  'achievement.streak-100.desc': '100 jours consécutifs',
  'achievement.perfect-10': 'Sans faute',
  'achievement.perfect-10.desc': '10 bonnes réponses d\'affilée',
  'achievement.session-complete': 'Assidu',
  'achievement.session-complete.desc': 'Terminez une session complète',
  'achievement.reviews-100': 'Débutant',
  'achievement.reviews-100.desc': '100 révisions',
  'achievement.reviews-1000': 'Vétéran',
  'achievement.reviews-1000.desc': '1000 révisions',

  // Quick actions
  browse_decks: 'Explorer',
  manage_your_vocabulary_decks: 'Parcourir tout le vocabulaire',
  grammar_tables: 'Grammaire',
  explore_greek_grammar: 'Tables de déclinaisons et conjugaisons',
  nt_reader: 'Lecteur NT',
  read_greek_new_testament: 'Lire le Nouveau Testament en grec',
  statistics: 'Statistiques',
  view_detailed_stats: 'Voir mes statistiques détaillées',
  settings: 'Paramètres',
  ...
  all_done: 'Bravo !',
  all_done_message: "Vous avez terminé vos révisions du jour. Revenez demain !",
  session_complete: 'Session terminée !',
  great_work: 'Excellent travail !',
  cards: 'Cartes',
  time: 'Temps',
  day_streak: 'jours consécutifs !',
  study_more: 'Continuer',
  press_1_4: 'Appuyez sur 1-4 pour noter',

  // Card review
  type_meaning: 'Tapez la traduction...',
  show_hint: 'Indice',
  hide_hint: 'Masquer',
  reveal: 'Révéler',
  ...
  how_well: 'Votre niveau de maîtrise ?',
  again: 'À revoir',
  hard: 'Difficile',
  good: 'Bien',
  easy: 'Facile',
  ...
  example: 'Exemple',
  in_nt: 'x dans le NT',
  swipe_hint: 'Glissez ou utilisez les boutons',
